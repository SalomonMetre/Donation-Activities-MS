...
$financialDonations = $financialModel->getFinancialsWhere(['ContribId' => $contribId]);
$events = $eventModel->getEventsWhere(['ContribId' => $contribId]);
$opportunities = $opportunityModel->getOpportunitiesWhere(['ContribId' => $contribId]);
    ...
    <div class="container-fluid" id="main-container">
        ...
        <div class="row" style="display: flex; flex-wrap: wrap; padding-top:3.5%;">
            ...
            <div class="col-md-9" style="padding:5%; background-color:#0F559B;">
                ...
                <div id="Financials">
                    <h3 style="text-align:center; margin:5%; color:white;"> My Financial Donations </h3>
                ...
                <div id="Events">
                    <h3 style="text-align:center; margin:5%; color:white;"> My Events </h3>
                    <div class="container-fluid" style="padding:3%;">
