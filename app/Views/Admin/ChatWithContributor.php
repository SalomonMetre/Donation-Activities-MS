            ...
            <div class="col-md-3" style="padding:5%; background-color: #041323;">
                <div class="container-fluid">
                    ...
                    <div class="row" style="color:white; text-align:center; padding:15%;">
                        ...
                        <div class="col-md-10">
                            <a href="<?= base_url('adminShowPage/ViewStatistics') ?>" style="text-decoration:none; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color:white;"> Statistics </a>
                        </div>
                    </div>
                    <div class="row" style="color:white; text-align:center; padding:15%;">
                        <div class="col-md-2">
