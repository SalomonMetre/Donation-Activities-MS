        ...
        <div class="row" style="display: flex; flex-wrap: wrap; padding-top:3.5%;">
            <div class="col-md-3" style="padding:5%; background-color: #041323;">
                <div class="container-fluid">
                    <div class="row" style="color:white; text-align:center; padding:15%; margin-top:-5%; background-color:#0F559B; margin-left:-45%; margin-right:-45%;">
                        <div class="col-md-2">
            ...
            <div class="col-md-9" style="padding:10%; background-color:#0F559B;">
                <div class="container-fluid" style="padding:7%; text-align:center;">
                    <div class="row">
                            <div class="col">
                            <form action="<?= base_url('adminEditDetails/') ?>" method="POST">
                                <input type="text" name="AdminId" value="<?= $admin['Id'] ?>" hidden>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="FirstName" id="Label" placeholder="" value="<?= $admin['FirstName'] ?>">
                                    <label for="floatingLabel"> First Name </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="LastName" id="Label" placeholder="" value="<?= $admin['LastName'] ?>">
                                    <label for="floatingLabel"> Last Name </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="Email" id="Label" placeholder="" value="<?= $admin['Email'] ?>">
                                    <label for="floatingLabel"> Email </label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="row">
                                <div class="col-md-10 form-floating mb-3" style="width:80%;">
                                    <input type="password" class="form-control" name="Password" id="Password" placeholder="" value="<?= $admin['Password'] ?>">
                                    <label for="floatingLabel"> Password </label>
                                </div>
                                <div class="col-md-2 form-check form-floating mb-3">
                                    <input class="form-check-input" type="checkbox" value="" id="" onclick="togglePassword()">
                                </div>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="Gender" id="Label" placeholder="" value="<?= $admin['Gender'] ?>" readonly>
                                    <label for="floatingLabel"> Gender </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="PhysicalAddress" id="Label" placeholder="" value="<?= $admin['PhysicalAddress'] ?>">
