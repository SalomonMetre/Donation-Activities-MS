                        ...
                        <tbody style="color:white;">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td> <a href="<?= base_url('Images/Uploads/' . $beneficiary['ProfilePicture']) ?>" style="text-decoration: none; color:cyan;"> <i class="bi bi-person-bounding-box"></i> </a> </td>
                                        <td> <a href="<?= base_url('Images/Uploads/' . $beneficiary['Resume']) ?>" style="color:cyan;"> <i class="bi bi-person-lines-fill"></i> </a> </td>
                                        <td> <?= $beneficiary['PhysicalLocation'] ?> </td>
                                        <td> <a href="<?= base_url('Images/Uploads/' . $beneficiary['FinancialDetails']) ?>" style="color:cyan;"> <i class="bi bi-arrow-90deg-right"></i> </a> </td>
                                        <td>
                                            <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#modelId<?= $beneficiary['Id'] ?>">
                                                <i class="bi bi-gear-wide-connected"></i>
                                            </button>
                                            <div class="modal fade" id="modelId<?= $beneficiary['Id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" style="color:#0F559B"> Edit beneficiary's Details </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <form method="POST" action="<?= base_url('adminEditBenef/') ?>">
                                                            <div class="modal-body">
                                                                <input type="text" name="BenefId" value="<?= $beneficiary['Id'] ?>" hidden>
                                                                <div class="form-floating mb-3">
                                                                    <input type="email" class="form-control" name="Email" id="Label" placeholder="" value="<?= $beneficiary['Email'] ?>">
                                                                ...
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control" name="PhoneNo" id="Label" placeholder="" value="<?= $beneficiary['PhoneNo'] ?>">
