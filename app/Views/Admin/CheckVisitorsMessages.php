...
$feedbackMessages = $feedbackMessageModel->getAllFeedbackMessages();
    ...
    <div class="container-fluid" id="main-container">
        ...
        <div class="row" style="display: flex; flex-wrap: wrap; padding-top:3.5%;">
            ...
            <div class="col-md-9" style="padding:5%; background-color:#0F559B;">
                <div style="margin:1%; background-color:#0A2B4C;color:white;font-size:2em;z-index:1; text-align:center; position:fixed; width:63%;">Visitors' Messages </div>
                <div class="container-fluid" style="padding:10%;">
                    <?php
                    if ($feedbackMessages) {
                        foreach ($feedbackMessages as $feedbackMessage) {
                    ?>
                            <div class="row" style="padding:3%; margin:1%;">
                                <div class="card">
                                    <div class="card-header">
                                        <span style="color:#0F559B"> From : </span> <?= $feedbackMessage['Email']; ?>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text"> <span style="color:#0F559B"> Message : </span> <?= $feedbackMessage['Message'] ?> </p>
                                    </div>
                                </div>
                            </div>
                    <?php
