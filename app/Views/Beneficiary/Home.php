        ...
        <div class="row" style="display: flex; flex-wrap: wrap; padding-top:3.5%;">
            ...
            <div class="col-md-9" style="padding:5%; background-color:#0F559B;">
                <div class="container-fluid" style="padding:9%; text-align:center;">
                    <div class="row">
                        <div class="col">
                            <form action="<?= base_url('benefEditDetails/') ?>" method="POST" enctype="multipart/form-data">
                                <input type="text" name="benefId" value="<?= $benef['Id'] ?>" hidden>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="FirstName" id="Label" placeholder="" value="<?= $benef['FirstName'] ?>" required>
                                    <label for="floatingLabel"> First Name  </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="LastName" id="Label" placeholder="" value="<?= $benef['LastName'] ?>" required>
                                    <label for="floatingLabel"> Last Name </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="Email" id="Label" placeholder="" value="<?= $benef['Email'] ?>" required>
                                ...
                                <div class="row">
                                    <div class="form-floating mb-3">
                                        <input type="date" class="form-control" name="BirthDate" id="Label" placeholder="" value="<?= $benef['BirthDate'] ?>" required>
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="PhysicalLocation" id="Label" placeholder="" value="<?= $benef['PhysicalLocation'] ?>" required>
                                    <label for="floatingLabel"> PhysicalLocation </label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="PhoneNo" id="Label" placeholder="" value="<?= $benef['PhoneNo'] ?>" required>
                                    <label for="floatingLabel"> Phone Number </label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-floating mb-3">
                                    <input type="file" class="form-control" name="FinancialDetails" id="Label" placeholder="" value="<?= $benef['ProfilePicture'] ?>" required>
