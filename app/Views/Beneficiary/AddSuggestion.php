    ...
    <div class="container-fluid" id="main-container">
        ...
        <div class="row" style="display: flex; flex-wrap: wrap; padding-top:3.5%;">
            ...
            <div class="col-md-9" style="padding:5%; background-color:#0F559B;">
                <div class="container-fuild" style="padding:5%; text-align:center;">
                    <div class="row">
                        <h3 style="color:white; margin-top:5%; margin-bottom:5%;"> Add Suggestion </h3>
                        <div class="col">
                            <form action="<?= base_url('benefAddSuggestion/') ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="Title" id="Label" placeholder="">
                                    <label for="floatingLabel"> Title </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <select name="Type" id="" style="width:100%; padding:5%;">
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating mb-3">
                                <input type="file" class="form-control" name="Info" id="Label" placeholder="">
                                <label for="floatingLabel"> Info </label>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-success" style="padding:2%;"> Add Suggestion </button>
                        </form>
                    </div>
                </div>
            </div>
