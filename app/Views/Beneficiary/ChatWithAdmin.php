...
$messageAdminId = session()->get('messageAdminId');
$benefId = session()->get('benef')['Id'];

$messages = $messageModel->getMessagesWhere(['SenderId' => $benefId, 'ReceiverId' => $messageAdminId], ['ReceiverId' => $benefId, 'SenderId' => $messageAdminId]);
    ...
    <div class="container-fluid" id="main-container">
        ...
        <div class="row" style="display: flex; flex-wrap: wrap; padding-top:3.5%;">
                            ...
                            <div class="modal fade" id="sendId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= base_url('benefAdminSendMessage/') ?>" method="POST" enctype="multipart/form">
                                            <div class="modal-body">
                                                <input type="text" name="MessageAdminId" value="<?= $messageAdminId ?>" hidden>
            ...
            <div class="col-md-9" style="padding:5%; background-color:#0F559B;">
                ...
                <div class="modal fade" id="receiverId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                    <div class="modal-dialog" role="document" style="margin: 10% 10% 0% 70%;">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('benefChangeMessageAdminId/') ?>" method="POST">
                                <div class="modal-body">
                                    <select name="MessageAdminId" id="selector" class="form-control" style="width:100%;">
                                        <?php
                                        if ($admins) {
                ...
                <div style="margin:1%; background-color:#0A2B4C;color:white;font-size:2em;z-index:1; text-align:center; position:fixed; width:50%;"> Chat With admin </div>
                <div class="container-fluid" style="overflow-y: scroll;height:25em;margin-top:5em;">
                    <?php
                    if ($messages) {
                        foreach ($messages as $message) {
                    ?>
                            <div class="row" style="padding:3%; margin:1%; <?php echo $message['SenderId'] == session()->get('benef')['Id'] ? 'margin-left:50%;' : 'margin-left:0%;' ?> width:45%;">
                                <div class="card">
